      ...
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        <div className="w-full bg-white border border-outline-variant rounded-lg p-xl">
          <form className="space-y-lg" onSubmit={handleSubmit}>
            ...
            {/* Primary Action */}
            <button 
              className="w-full h-11 bg-primary text-white font-label-md text-label-md font-bold rounded-lg transition-colors hover:bg-primary-container active:scale-[0.98] duration-200 disabled:opacity-70 disabled:cursor-not-allowed" 
              type="submit"
              disabled={isLoading}
            >
