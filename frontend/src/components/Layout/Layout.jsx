...
const Layout = () => {
  ...
  const navigation = [
    { name: 'Fleet Overview', href: '/dashboard', icon: 'dashboard', roles: ['Fleet Manager', 'Driver', 'Safety Officer', 'Financial Analyst'] },
    { name: 'Vehicle Tracking', href: '/vehicles', icon: 'location_on', roles: ['Fleet Manager', 'Driver', 'Financial Analyst'] },
    { name: 'Maintenance Logs', href: '/maintenance', icon: 'build', roles: ['Fleet Manager', 'Driver'] },
    { name: 'Driver Schedules', href: '/drivers', icon: 'calendar_today', roles: ['Fleet Manager', 'Safety Officer'] },
    { name: 'Trips', href: '/trips', icon: 'route', roles: ['Fleet Manager', 'Driver', 'Safety Officer', 'Financial Analyst'] },
